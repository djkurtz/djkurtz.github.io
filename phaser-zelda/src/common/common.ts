...
export const CHEST_REWARD_TO_DIALOG_MAP = {
    SMALL_KEY: 'You found a small key! You can use it to open locked doors.',
    BOSS_KEY: 'You got the Big Key! This is the master key of the dungeon. It can open many locks that small keys cannot.',
