...
export const PLAYER_HURT_PUSHBACK_SPEED = 50;
export const PLAYER_START_MAX_LIFE = 6;
...
export const ENEMY_SPIDER_HURT_PUSHBACK_SPEED = 50;
export const ENEMY_SPIDER_START_MAX_HEALTH = 2;

export const ENEMY_WISP_SPEED = 50;
export const ENEMY_WISP_ANIMATION_SCALE_X = 1.2;
export const ENEMY_WISP_ANIMATION_SCALE_Y = 1.2;
export const ENEMY_WISP_ANIMATION_DURATION = 500;
export const ENEMY_WISP_START_MAX_HEALTH = 1;

export const ENEMY_BOSS_DROW_SPEED = 80;
export const ENEMY_BOSS_DROW_START_MAX_HEALTH = 6;
