...
import { ENEMY_WISP_ANIMATION_DURATION, ENEMY_WISP_ANIMATION_SCALE_X, ENEMY_WISP_ANIMATION_SCALE_Y, ENEMY_WISP_SPEED, ENEMY_WISP_START_MAX_HEALTH } from "../../common/config";
